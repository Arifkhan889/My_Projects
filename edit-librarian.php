        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Edit Registered Librarian</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Edit Registered Librarian</h3>
 <a href="add-librarian.php" class="btn btn-primary btn-sm float-right">Back</a>
      ...
      <div class="modal-body">
      	...
      	if(isset($_GET['id'])){
      	$user_id=$_GET['id'];
         $query="SELECT * FROM librarian where id='$user_id'";
